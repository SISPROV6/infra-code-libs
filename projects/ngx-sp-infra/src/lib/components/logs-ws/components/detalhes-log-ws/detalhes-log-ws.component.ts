...
@Component({
  selector: 'app-detalhes-log-ws',
  templateUrl: './detalhes-log-ws.component.html',
  styleUrls: ['./detalhes-log-ws.component.scss'],
  imports: [InfraModule, RouterLinkActive, RouterLink, DatePipe],
  providers: [TenantService]
})
export class DetalhesLogWSComponent implements OnInit {
