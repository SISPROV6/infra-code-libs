...
export class EmpresaAbasComponent implements OnInit{
  ...
  ngOnInit(): void {
    if(window.location.host.includes("localhost")){
      ...
      {nome: 'Compras', uri: `https://${window.location.host}/SisproErpCloud/Compras/empresa-compras/editar/${this.Id}`, isTargetSelf: false},
      {nome: 'Recebimento', uri: `https://${window.location.host}/SisproErpCloud/Recebimento/configuracao-empresa/editar/${this.Id}`, isTargetSelf: false},
      ...
      {nome: 'Financeiro', uri: `https://${window.location.host}/SisproErpCloud/Financeiro/empresa-estab/editar/empresa/${this.Id}`, isTargetSelf: false},
