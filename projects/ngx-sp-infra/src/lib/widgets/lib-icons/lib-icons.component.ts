...
export class LibIconsComponent implements OnInit, OnChanges {
  ...
  private checkName(): void {
    const hasIcon: boolean = this.iconsList.getIcon(this.iconName) ? true : false;
  ...
  public getSVG(): void {
    const unsanitizedSVG = this.iconsList.getIcon(this.iconName) ? this.iconsList.getIcon(this.iconName)!.svg ?? "" : "";
