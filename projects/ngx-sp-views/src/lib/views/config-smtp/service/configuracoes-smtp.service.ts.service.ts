...
export class ConfiguracoesSmtpService {
  ...
  constructor(
    ...
    this._BASE_URL_CONFIG_ERP = `${ this._customEnvironmentService.SpInfra2ConfigErpWS }/ConfigSMTP`; // SpInfra2ConfigErpWS
    ...
    this._BASE_URL_CRP = `${ this._customEnvironmentService.SpCrp2InfraWS }/InfraEmailCfg`; // SpInfra2ConfigErpWS
